...
*/
                ...
                a: {
                    ...
                    null != b &&
                        (a
                            ...
                            : b !== c && (void 0 === fa[d] && ((a = (1e9 * Math.random()) >>> 0), (fa[d] = ea ? da.Symbol(d) : "$jscp$" + a + "$" + d)), ba(f, fa[d], { configurable: !0, writable: !0, value: b })));
                }
        };
    r(
        "Symbol",
    ...
    var ha = function (a) {
        ...
        ka =
            ea && "function" == typeof q(Object, "assign")
                ? q(Object, "assign")
                : function (a, b) {
    ...
    r(
        ...
        function (a) {
            ...
            c.prototype.set = function (g, k) {
                ...
                l.s ? (l.s.value = k) : ((l.s = { next: this.g, B: this.g.B, head: this.g, key: g, value: k }), l.list.push(l.s), (this.g.B.next = l.s), (this.g.B = l.s), this.size++);
                return this;
            };
            c.prototype.delete = function (g) {
                g = d(this, g);
                return g.s && g.list ? (g.list.splice(g.index, 1), g.list.length || delete this.h[g.id], (g.s.B.next = g.s.next), (g.s.next.B = g.s.B), (g.s.head = null), this.size--, !0) : !1;
            };
            ...
            var d = function (g, k) {
                    ...
                    if (n && x(g.h, l))
                        for (g = 0; g < n.length; g++) {
                            var v = n[g];
                            if ((k !== k && v.key !== v.key) || k === v.key) return { id: l, list: n, index: g, s: v };
                        }
                    return { id: l, list: n, index: -1, s: void 0 };
                },
                e = function (g, k) {
                    var l = g.g;
                    return ha(function () {
                        if (l) {
                            for (; l.head != g.g; ) l = l.B;
        ...
        function (a) {
            return a
                ...
                : function (b, c, d) {
                      ...
                      var e = [],
                          f = "undefined" != typeof p.Symbol && q(p.Symbol, "iterator") && b[q(p.Symbol, "iterator")];
    ...
    Xa[" "] = function () {};
    var Ya = Oa() ? !1 : C("Trident") || C("MSIE");
    !C("Android") || Pa();
    Pa();
    C("Safari") && (Pa() || (Oa() ? 0 : C("Coast")) || (Oa() ? 0 : C("Opera")) || (Oa() ? 0 : C("Edge")) || (Oa() ? Na("Microsoft Edge") : C("Edg/")) || (Oa() && Na("Opera")));
    var Za = {},
        $a = null,
        bb = function (a) {
            var b = [];
    ...
    var D = "function" === typeof p.Symbol && "symbol" === typeof (0, p.Symbol)() ? (0, p.Symbol)() : void 0;
    function fb(a, b) {
        if (D) return (a[D] |= b);
    ...
    function gb(a) {
        var b = E(a);
        1 !== (b & 1) && (Object.isFrozen(a) && (a = Array.prototype.slice.call(a)), F(a, b | 1));
    }
    function E(a) {
        var b;
        D ? (b = a[D]) : (b = a.g);
    ...
    function F(a, b) {
        D ? (a[D] = b) : void 0 !== a.g ? (a.g = b) : Object.defineProperties(a, { g: { value: b, configurable: !0, writable: !0, enumerable: !1 } });
        return a;
    }
    function hb(a, b) {
    ...
    function wb(a, b, c) {
        var d = !1;
        if (null != a && "object" === typeof a && !(d = Array.isArray(a)) && a.O === mb) return a;
        if (d) {
            var e = (d = E(a));
            0 === e && (e |= c & 16);
            e |= c & 2;
    ...
    var xb = "function" === typeof p.Symbol && "symbol" === typeof (0, p.Symbol)() ? (0, p.Symbol)() : "di";
    ...
    function yb(a, b, c) {
        ...
        b = E(a);
        b & 1 || ib(a);
        c ? b & 2 || fb(a, 18) : b & 16 && !(b & 2) && ((c = a), D ? c[D] && (c[D] &= -17) : void 0 !== c.g && (c.g &= -17));
        return a;
    }
    function zb(a, b, c) {
        var d = !!(E(a.l) & 2),
            ...
            f = E(e);
        if (!(f & 4)) {
            Object.isFrozen(e) && ((e = ib(e.slice())), H(a, b, e));
        ...
        !d && (f & 2 || Object.isFrozen(e)) && ((e = Array.prototype.slice.call(e)), fb(e, 5), H(a, b, e));
        return e;
    }
    function Ab(a, b, c, d) {
        if (null == c) return I(a, b);
        var e = E(c);
        if (!(e & 4)) {
    ...
    var Db = function (a, b, c, d) {
            qb(a);
            (c = Cb(a, c)) && c !== b && null != d && H(a, c, void 0, !1);
            return H(a, b, d);
        },
        K = function (a, b, c) {
            return Cb(a, b) === c ? c : -1;
        ...
        Fb = function (a, b) {
            (a = Eb(a, b, 1, !1)) ? (b = a) : (a = b[xb]) ? (b = a) : ((a = new b()), fb(a.l, 18), (b = b[xb] = a));
            return b;
        },
        L = function (a, b, c) {
            var d = void 0 === d ? !1 : d;
        ...
        M = function (a, b, c) {
            ...
            var f = e ? 1 : 2,
                h = !!(d & 2),
                g = yb(a, c, h);
            if (g !== pb && E(g) & 4) 3 === f || h || ((h = Object.isFrozen(g)), 1 === f ? h || Object.freeze(g) : ((f = E(g)), (b = f & -19), h && ((g = Array.prototype.slice.call(g)), (f = 0), H(a, c, g)), f !== b && F(g, b))), (a = g);
            else {
                var k = g;
                g = !!(d & 2);
                var l = !!(E(k) & 2);
                ...
                var n = d | (l ? 2 : 0);
                d = l;
                for (var v = (l = 0); l < k.length; l++) {
                    var t = wb(k[l], b, n);
                    void 0 !== t && (d || (d = !!(2 & E(t.l))), (k[v++] = t));
                }
                v < l && (k.length = v);
                b = k;
                k = E(b);
            ...
            if (!(e || E(a) & 8)) {
                for (e = 0; e < a.length; e++) (c = a[e]), (f = Gb(c)), c !== f && (a[e] = f);
                fb(a, 8);
            }
            return a;
        },
    ...
    function Rb(a, b) {
        ...
        if (d) {
            e = c[f] = {};
            for (var h in d) Object.prototype.hasOwnProperty.call(d, h) && (e[h] = b(d[h]));
        }
        b = Ob(a.constructor, jb(c));
        a.m && (b.m = a.m.slice());
        return b;
    }
    function Sb(a, b, c, d, e, f) {
        if (null != a) {
            if (Array.isArray(a)) a = e && 0 == a.length && E(a) & 1 ? void 0 : f && E(a) & 2 ? a : Tb(a, b, c, void 0 !== d, e, f);
            else if (nb(a)) {
                var h = {},
                    g;
                for (g in a) Object.prototype.hasOwnProperty.call(a, g) && (h[g] = Sb(a[g], b, c, d, e, f));
                a = h;
            } else a = b(a, d);
            return a;
        }
    ...
    function Tb(a, b, c, d, e, f) {
        ...
        for (var g = 0; g < a.length; g++) a[g] = Sb(a[g], b, c, d, e, f);
        c && c(h, a);
        return a;
    }
    function Ub(a) {
        return a.O === mb ? a.toJSON() : Qb(a);
    }
    function Vb(a, b, c) {
        c = void 0 === c ? lb : c;
        if (null != a) {
            ...
            if (Array.isArray(a)) {
                ...
                a = Tb(a, Vb, d & 4 ? lb : c, !0, !1, !0);
                b = E(a);
                b & 4 && b & 2 && Object.freeze(a);
                return a;
            }
            a.O === mb && (E(a.l) & 2 || ((a = Wb(a, !0)), fb(a.l, 18)));
            return a;
        }
    }
    function Wb(a, b) {
        var c = b || E(a.l) & 2 ? lb : kb,
            d = !!(E(a.l) & 16);
        return Rb(a, function (e) {
            return Vb(e, d, c);
        });
    }
    function Gb(a) {
    ...
    P.prototype.toJSON = function () {
        if (ob) var a = Xb(this, this.l, !1);
        else (a = Tb(this.l, Ub, void 0, void 0, !1, !1)), (a = Xb(this, a, !0));
        return a;
    };
    var Yb = function (a) {
        ob = !0;
    ...
    P.prototype.O = mb;
    function Xb(a, b, c) {
        var d = a ? a.constructor.o : void 0,
            e = a.h;
        if (d) {
            if (!c) {
                b = Array.prototype.slice.call(b);
                var f;
                if (b.length && nb((f = b[b.length - 1])))
                    for (var h = 0; h < d.length; h++)
                        if (d[h] >= e) {
                            q(Object, "assign").call(Object, (b[b.length - 1] = {}), f);
                            break;
                        }
            }
            e = b;
            ...
            for (h = 0; h < d.length; h++) {
                ...
                if (k < f) {
                    k += a.i;
                    var l = e[k];
                    null == l ? (e[k] = c ? pb : ib([])) : c && l !== pb && gb(l);
                } else g || ((l = void 0), e.length && nb((l = e[e.length - 1])) ? (g = l) : e.push((g = {}))), (l = g[k]), null == g[k] ? (g[k] = c ? pb : ib([])) : c && l !== pb && gb(l);
            }
        }
        return b;
    }
    ...
    var gc = function (a) {
            return a instanceof Q && a.constructor === Q && a.i === fc ? a.h : "type_error:Const";
        },
        fc = {},
        ec = {};
    var hc = function (a) {
    ...
    var kc = { area: !0, base: !0, br: !0, col: !0, command: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 };
    var R = function (a) {
        this.h = a;
    };
    ...
    var pc = /^data:(.*);base64,[a-z0-9+\/]+=*$/i,
        ...
        rc = {},
        sc = new S("about:invalid#zClosurez", rc);
    var tc = {},
        uc = function (a) {
            this.h = a;
            this.D = !0;
    ...
    var vc = function (a) {
            return a instanceof uc && a.constructor === uc ? a.h : "type_error:SafeHtml";
        },
        wc = function (a) {
            return a instanceof uc ? a : new uc(Fa("object" == typeof a && a.D ? a.g() : String(a)), tc);
        },
        Ac = function (a, b) {
            var c = { src: a },
                d = {};
            ...
            if (a)
                for (k in a)
                    if (Object.prototype.hasOwnProperty.call(a, k)) {
                        ...
                        if (null != c) {
                            h = k;
                            if (c instanceof Q) c = gc(c);
                            else {
                                if ("style" == h.toLowerCase()) throw Error("");
                                if (/^on/i.test(h)) throw Error("");
                                if (h.toLowerCase() in yc)
                                    if (c instanceof R) c = lc(c).toString();
                                    else if (c instanceof S) c = c instanceof S && c.constructor === S ? c.h : "type_error:SafeUrl";
                                    else if ("string" === typeof c)
                                        c instanceof S ||
                                            ((c = "object" == typeof c && c.D ? c.g() : String(c)), qc.test(c) ? (c = new S(c, rc)) : ((c = String(c)), (c = c.replace(/(%0A|%0D)/g, "")), (c = c.match(pc) ? new S(c, rc) : null))),
                                            (c = (c || sc).g());
                                    else throw Error("");
                            }
                            c.D && (c = c.g());
            ...
            !0 === kc.script ? (k += ">") : ((g = zc(g)), (k += ">" + vc(g).toString() + "\x3c/script>"));
            return new uc(k, tc);
        },
        Cc = function (a) {
            var b = wc(Bc),
        ...
        xc = /^[a-zA-Z0-9-]+$/,
        yc = { action: !0, cite: !0, data: !0, formaction: !0, href: !0, manifest: !0, poster: !0, src: !0 },
        Bc = new uc((z.trustedTypes && z.trustedTypes.emptyHTML) || "", tc);
    var Ec = function () {
            a: {
                var a = z.document;
                if (a.querySelector && (a = a.querySelector("script[nonce]")) && (a = a.nonce || a.getAttribute("nonce")) && Dc.test(a)) break a;
                a = "";
            }
            return a;
        },
        Dc = /^[\w+/_-]+[=]{0,2}$/;
    var Fc = function () {
        return Ia && A ? !A.mobile && (C("iPad") || C("Android") || C("Silk")) : C("iPad") || (C("Android") && !C("Mobile")) || C("Silk");
    };
...
*/
    ...
    var Mc = function (a) {
        ...
        Zc = hc(function () {
            return (Ia && A ? A.mobile : !Fc() && (C("iPod") || C("iPhone") || C("Android") || C("IEMobile"))) ? 2 : Fc() ? 1 : 0;
        }),
        $c = function (a) {
    ...
    function bd(a) {
        ...
        if (0 === b.length) return new R(a[0], nc);
    ...
    function cd(a, b) {
        ...
        b.forEach(function (e, f) {
            ...
            for (var h = 0; h < e.length; h++) {
                var g = e[h];
                null !== g && void 0 !== g && ((c += d + encodeURIComponent(f) + "=" + encodeURIComponent(String(g))), (d = "&"));
            }
        });
        return new R(c, nc);
    }
    var dd = { Ha: 0, Ga: 1, Da: 2, ya: 3, Ea: 4, za: 5, Fa: 6, Ba: 7, Ca: 8, xa: 9, Aa: 10 };
    var ed = { Ja: 0, Ka: 1, Ia: 2 };
    var fd = "a".charCodeAt(),
        gd = jc(dd),
        hd = jc(ed);
    var id = function (a) {
    ...
    var nd = function (a, b) {
            try {
                ...
                c.purpose = { consents: md(kd(d, 24, gd), gd), legitimateInterests: md(kd(d, 24, gd), gd) };
                c.purposeOneTreatment = !!T(d, 1);
                c.publisherCC = String.fromCharCode(fd + T(d, 6)) + String.fromCharCode(fd + T(d, 6));
                c.vendor = { consents: md(ld(d), b), legitimateInterests: md(ld(d), b) };
                return c;
            } catch (e) {
                return null;
            }
    ...
    function od(a) {
        return JSON.stringify([
            a.map(function (b) {
                var c = {};
                return [((c[b.ja] = b.ha), c)];
            }),
        ]);
    }
    var pd = function (a, b) {
        if (p.globalThis.fetch) p.globalThis.fetch(a, { method: "POST", body: b, keepalive: 65536 > b.length, credentials: "omit", mode: "no-cors", redirect: "follow" }).catch(function () {});
        else {
    ...
    function Md(a) {
        a.ia.apply(
            a,
            w(
                sa.apply(1, arguments).map(function (b) {
                    return { ja: 2, ha: b.toJSON() };
                })
            )
        );
    }
    ...
    Pd.prototype.ia = function () {
        var a = sa.apply(0, arguments),
            b = this;
        this.j && 65536 <= od(this.g.concat(a)).length && Qd(this);
    ...
    var Rd = function (a, b, c) {
        Pd.call(this, "https://pagead2.googlesyndication.com/pagead/ping", pd, void 0 === a ? 1e3 : a, void 0 === b ? 100 : b, (void 0 === c ? !1 : c) && !!p.globalThis.fetch);
    };
    y(Rd, Pd);
    var Sd = function (a, b) {
            this.g = a;
    ...
    ee.prototype.set = function (a, b, c) {
        ...
        this.g.cookie =
            ...
            (f ? ";domain=" + f : "") +
            (h ? ";path=" + h : "") +
            (0 > g ? "" : 0 == g ? ";expires=" + new Date(1970, 1, 1).toUTCString() : ";expires=" + new Date(Date.now() + 1e3 * g).toUTCString()) +
            (d ? ";secure" : "") +
            (null != e ? ";samesite=" + e : "");
    };
    ...
    ee.prototype.clear = function () {
        ...
        for (a = b.length - 1; 0 <= a; a--) (c = b[a]), this.get(c), this.set(c, "", { ra: 0, path: void 0, domain: void 0 });
    };
    function fe(a) {
    ...
    jc(dd).map(function (a) {
        return Number(a);
    });
    jc(ed).map(function (a) {
        return Number(a);
    });
    var he = function (a) {
            this.g = a;
            ...
            a.h = function (b) {
                ...
                !e ||
                    ...
                    a.g.__tcfapi(
                        ...
                        function (f, h) {
                            var g = {};
                            g.__tcfapiReturn = "removeEventListener" === e.command ? { success: f, callId: e.callId } : { returnValue: f, success: h, callId: e.callId };
    ...
    var le = function (a) {
            this.g = a;
            var b;
            this.j = (b = (b = ge(a.document)) ? L(b, ae, 5) || null : null) ? G(b, 2) : null;
            this.h = (b = fe(a.document)) && null != G(b, 1) ? G(b, 1) : null;
            this.i = (a = fe(a.document)) && null != G(a, 2) ? G(a, 2) : null;
        },
        oe = function (a) {
            a.__uspapi || a.frames.__uspapiLocator || ((a = new le(a)), me(a), ne(a));
        },
        me = function (a) {
            !a.j ||
                a.g.__uspapi ||
    ...
    var ne = function (a) {
        !a.h ||
            ...
            wa("__tcfapi", function () {
                return a.m.apply(a, w(sa.apply(0, arguments)));
            }),
            je(a.g));
    };
    le.prototype.m = function (a, b, c, d) {
        d = void 0 === d ? null : d;
    ...
    function Ae(a, b) {
        ...
        if (d && (b = (b = b[c]) && b[d])) {
            try {
                var e = b.apply(null, w(zb(a, 8, vb)));
            } catch (f) {
                return;
            }
            b = O(a, 1);
    ...
    function Qe(a, b, c, d) {
        var e = (d = void 0 === d ? 0 : d),
            f,
            h;
        U(V).i[e] = null != (h = null == (f = U(V).i[e]) ? void 0 : f.add(b)) ? h : new p.Set().add(b);
        e = Pe();
    ...
    function Ye(a, b, c, d, e) {
        ...
        Qa(b, function (g) {
            ...
            Qa(a, function (l) {
                ...
                if (v) {
                    var t, B, pa;
                    var Bb = null != (pa = null == (t = U(V).g.get(g)) ? void 0 : null == (B = t.get(v)) ? void 0 : B.slice(0)) ? pa : [];
                    a: {
                        t = new Bd();
                        switch (n) {
                            case 1:
                    ...
                    if ((Bb = n)) {
                        var Ta;
                        Bb = !(null == (Ta = U(V).i[g]) || !Ta.has(v));
                    }
                    Bb && f.push(n);
                    if ((Ta = n)) {
                        var ia;
                        Ta = !(null == (ia = U(V).g.get(g)) || !ia.has(v));
                    }
                    Ta && h.push(n);
                    e || ((ia = U(V)), ia.g.has(g) || ia.g.set(g, new p.Map()), ia.g.get(g).has(v) || ia.g.get(g).set(v, []), d && ia.g.get(g).get(v).push(d));
                    k[v] = l.toJSON();
                }
            });
        });
        (f.length || h.length) && Ke(c, f, h, null != d ? d : void 0);
    }
    function Ze(a, b) {
        var c = Re(b);
        Qa(a, function (d) {
    ...
    function $e() {
        return Sa(q(Object, "keys").call(Object, U(V).h), function (a) {
            return Number(a);
        });
    }
    function af(a) {
        Wa(U(V).j, a) || Xe(Re(4), a);
    }
    function W(a, b, c) {
    ...
    function cf(a) {
        ...
        W(
            14,
            function (b) {
                for (var c = U(Le), d = u([3, 4, 5]), e = d.next(); !e.done; e = d.next()) (e = e.value), q(Object, "assign").call(Object, c.u[e], b[e]);
            },
            a
        );
    }
        ...
        nf =
            ((mf[3] =
                ...
                (jf[69] = function (a) {
                    ...
                    b = void 0 === b ? document : b;
                    var c;
                    return !(null == (c = b.featurePolicy) || !((m = c.features()), q(m, "includes")).call(m, a));
                }),
                (jf[70] = function (a) {
                    var b = z.document;
                    b = void 0 === b ? document : b;
                    var c;
                    return !(null == (c = b.featurePolicy) || !((m = c.allowedFeatures()), q(m, "includes")).call(m, a));
                }),
                jf)),
            (mf[4] =
                ((kf[3] = function () {
    ...
    var uf = [12, 13, 20],
        ...
        zf = function (a, b, c) {
            ...
            if (f) return Je(a.A, b, c, d, [], 4), d;
            if (!e.length) return Je(a.A, b, c, d, [], 3), d;
            var h = Wa(uf, b),
                g = [];
            Qa(e, function (k) {
                var l = new td();
                if ((k = xf(a, k, c, l))) 0 !== Cb(l, ud) && g.push(l), (l = k.getId()), d.push(l), yf(a, l, h ? 4 : c), (k = M(k, Ee, 2)) && (h ? Ye(k, $e(), a.A, l) : Ye(k, [c], a.A, l));
            });
            Je(a.A, b, c, d, g, 1);
            return d;
        },
        ...
        xf = function (a, b, c, d) {
            ...
            c = d.length * N(sb(G(b, 1)), 0);
            return (b = O(b, 4)) ? Df(a, b, c, d) : Cf(a, d, c / 1e3);
        },
        Df = function (a, b, c, d) {
    ...
    function Gf(a) {
        return U(Ff).h(a.g, a.defaultValue);
    }
    var Hf = function () {
            this.g = function () {};
        },
    ...
    var Kf, Lf, Mf, Nf, Of, Pf;
    function Qf(a) {
        var b = a.na,
            c = a.u,
            d = a.La,
            e = void 0 === a.ka ? of() : a.ka,
            f = void 0 === a.ea ? 0 : a.ea;
        a =
            void 0 === a.A
                ? new He(
                      null != (Nf = null == (Kf = L(b, sf, 5)) ? void 0 : N(G(Kf, 2), 0)) ? Nf : 0,
                      null != (Of = null == (Lf = L(b, sf, 5)) ? void 0 : N(G(Lf, 4), 0)) ? Of : 0,
                      null != (Pf = null == (Mf = L(b, sf, 5)) ? void 0 : Kb(Mf, 3)) ? Pf : !1
                  )
                : a.A;
        e.hasOwnProperty("init-done")
            ? (X(12, e, function () {})(
                  Sa(M(b, rf, 2), function (h) {
                      return h.toJSON();
                  })
              ),
              X(13, e, function () {})(
                  Sa(M(b, Ee, 1), function (h) {
                      return h.toJSON();
                  }),
                  f
              ),
              c && X(14, e, function () {})(c),
              Rf(f, e))
            : (Ef(new vf(M(b, rf, 2), f, a, d), e), bf(e), cf(e), df(e), Rf(f, e), Ye(M(b, Ee, 1), [f], a, void 0, !0), (Me = Me || !(!d || !d.Na)), Jf(nf), c && Jf(c));
    }
    function Rf(a, b) {
    ...
    var Uf = ja(["https://pagead2.googlesyndication.com/pagead/js/err_rep.js"]),
        Vf = function () {
            var a = void 0 === a ? "jserror" : a;
            var b = void 0 === b ? 0.01 : b;
            var c = void 0 === c ? bd(Uf) : c;
            this.i = a;
            this.h = b;
            this.g = c;
        };
        ...
        Xf = function (a, b) {
            ...
            c.fetch
                ? ((b = { keepalive: !0, credentials: "include", redirect: "follow", method: "get", mode: "no-cors" }),
                  d &&
                      ((b.mode = "cors"),
                      "setAttributionReporting" in XMLHttpRequest.prototype ? (b.attributionReporting = { eventSourceEligible: "true", triggerEligible: "false" }) : (b.headers = { "Attribution-Reporting-Eligible": "event-source" })),
                  c.fetch(a, b))
                : Wf(c, a, void 0 === b ? !1 : b, void 0 === d ? !1 : d);
        };
    function Zf(a) {
        a = void 0 === a ? z : a;
            ...
            return function () {
                ...
                try {
                    ...
                    e.google_measure_js_timing &&
                        h &&
                        $f(q(Object, "assign").call(Object, {}, { label: a.toString(), value: h, duration: (Zf() || 0) - h, type: g }, d && f && { taskId: (e.google_rum_task_id_counter = e.google_rum_task_id_counter || 1) }), e);
                }
                return k;
            };
        },
        cg = function (a, b) {
            return bg(a, b, function (c, d) {
                var e = new Vf();
                var f = void 0 === f ? e.h : f;
                var h = void 0 === h ? e.i : h;
                Math.random() > f ||
                    ((d.error && d.meta && d.id) || (d = new re(d, { context: c, id: h })),
                    (z.google_js_errors = z.google_js_errors || []),
                    z.google_js_errors.push(d),
                    z.error_rep_loaded || ((f = z.document), (c = ad("SCRIPT", f)), Kc(c, e.g), (e = f.getElementsByTagName("script")[0]) && e.parentNode && e.parentNode.insertBefore(c, e), (z.error_rep_loaded = !0)));
            });
        };
    function Y(a, b) {
    ...
    function fg(a) {
        a = a.id;
        return null != a && (eg().has(a) || q(a, "startsWith").call(a, "google_ads_iframe_") || q(a, "startsWith").call(a, "aswift"));
    }
    function gg(a, b, c) {
    ...
    var mg = function () {
            ...
            this.T = this.V = this.W = this.Y = this.da = this.m = this.ca = this.K = 0;
            this.U = !1;
    ...
    var rg = function () {
            ...
            if (Gf($d)) {
                ...
                if (!b.google_plmetrics && window.PerformanceObserver) {
                    ...
                    for (var c = b.next(); !c.done; c = b.next()) (c = c.value), pg(a).observe({ type: c, buffered: !0 });
                    qg(a);
                }
            }
        },
        pg = function (a) {
            a.A ||
                (a.A = new PerformanceObserver(
                    cg(640, function (b) {
                        var c = ng !== window.scrollX || og !== window.scrollY ? [] : sg,
                            d = tg();
                        b = u(b.getEntries());
                            ...
                            switch (((e = e.value), e.entryType)) {
                                case "layout-shift":
                                    ...
                                    if (!e.hadRecentInput) {
                                        ...
                                        var h = gg(e, c, d);
                                        h && ((f.m += e.value), f.Y++);
                                        if (5e3 < e.startTime - f.X || 1e3 < e.startTime - f.aa) (f.X = e.startTime), (f.g = 0), (f.h = 0);
                                        f.aa = e.startTime;
                                        f.g += e.value;
                                        h && (f.h += e.value);
                                        f.g > f.K && ((f.K = f.g), (f.da = f.h), (f.ca = e.startTime + e.duration));
                                    }
                                    break;
                                ...
                                case "first-input":
                                    ...
                                    break;
                                case "longtask":
                                    (e = Math.max(0, e.duration - 50)), (a.C += e), (a.R = Math.max(a.R, e)), (a.J += 1);
                            }
                    })
                ));
            return a.A;
        ...
        qg = function (a) {
            var b = cg(641, function () {
                    var d = document;
                    2 === (d.prerendering ? 3 : { visible: 1, hidden: 2, prerender: 3, preview: 4, unloaded: 5 }[d.visibilityState || d.webkitVisibilityState || d.mozVisibilityState || ""] || 0) && ug(a);
                }),
                c = cg(641, function () {
                    return void ug(a);
                });
    ...
    var ug = function (a) {
            if (!a.Z) {
                ...
                window.LayoutShift &&
                    ((b += dg("cls", a.G)), (b += dg("mls", a.H)), (b += Y("nls", a.I)), window.LayoutShiftAttribution && ((b += dg("cas", a.m)), (b += Y("nas", a.Y)), (b += dg("was", a.da))), (b += dg("wls", a.K)), (b += dg("tls", a.ca)));
                window.LargestContentfulPaint && ((b += Y("lcp", a.W)), (b += Y("lcps", a.V)));
                window.PerformanceEventTiming && a.U && (b += Y("fid", a.T));
                window.PerformanceLongTaskTiming && ((b += Y("cbt", a.C)), (b += Y("mbt", a.R)), (b += Y("nlt", a.J)));
                for (var c = 0, d = u(document.getElementsByTagName("iframe")), e = d.next(); !e.done; e = d.next()) fg(e.value) && c++;
                b += Y("nif", c);
                ...
                b += "&top=" + (z === z.top ? 1 : 0);
                b += a.ba ? "&qqid=" + encodeURIComponent(a.ba) : Y("pvsid", $c(z));
        ...
        tg = function () {
            var a = q(Array, "from").call(Array, document.getElementsByTagName("iframe")).filter(fg),
                b = []
                    .concat(w(eg()))
                    .map(function (c) {
            ...
            ng = window.scrollX;
            og = window.scrollY;
            return (sg = [].concat(w(a), w(b)).map(function (c) {
    ...
    y(vg, P);
    vg.prototype.getVersion = function () {
        return Mb(this, 2);
    };
    var wg = function (a) {
        P.call(this, a);
    ...
    var xg = function (a, b) {
        ...
        Dg = function (a, b) {
            return I(a, 11, null == b ? b : !!b);
        },
        Eg = function (a, b) {
            return I(a, 1, b);
        },
        Fg = function (a, b) {
            return I(a, 7, null == b ? b : !!b);
        };
    wg.o = [10, 6];
    var Gg = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");
    function Hg(a) {
        var b;
    ...
    function Jg(a) {
        ...
        a = a.navigator.userAgentData.getHighEntropyValues(Gg).then(function (c) {
    ...
    function Kg(a) {
        ...
        return Dg(
            Cg(
                Ag(xg(Eg(zg(Fg(Bg(yg(new wg(), a.architecture || ""), a.bitness || ""), a.mobile || !1), a.model || ""), a.platform || ""), a.platformVersion || ""), a.uaFullVersion || ""),
    ...
    var Z = {},
        Ng = ((Z[23] = 0.001), (Z[253] = !1), (Z[246] = []), (Z[150] = ""), (Z[221] = Yc()), (Z[36] = Yc()), (Z[172] = null), (Z[260] = void 0), (Z[251] = null), Z),
        Og = function () {
            this.g = !1;
        };
    function Pg(a) {
    ...
    var Rg = /^(?:https?:)?\/\/(?:www\.googletagservices\.com|securepubads\.g\.doubleclick\.net|(pagead2\.googlesyndication\.com))(\/tag\/js\/gpt(?:_[a-z]+)*\.js|\/pagead\/managed\/js\/gpt\.js)/;
    function Sg(a) {
        return a ? !Rg.test(a.src) : !0;
    }
    function Tg(a) {
        var b = a.qa,
            c = a.wa,
        ...
        return (
            (k[3] =
                ...
                (a[59] = function () {
                    ...
                    var pa;
                    B = null != (pa = null == (t = Hc(B.location.href.match(Gc)[3] || null)) ? void 0 : t.split(".")) ? pa : [];
                    t = 2 > B.length ? null : "uk" === B[B.length - 1] ? (3 > B.length ? null : Vc(B.splice(B.length - 3).join("."))) : Vc(B.splice(B.length - 2).join("."));
                    return n.call(l, v(t));
                }),
                (a[61] = function () {
                    return d;
                ...
                (a[73] = function (l) {
                    return q(c, "includes").call(c, Number(l));
                }),
                a)),
            (k[4] =
                ((g[1] = function () {
    ...
    function Ug(a, b) {
        var c = new tf(Pg(246));
        if (!M(c, Ee, 1).length && M(a, Ee, 1).length) {
            var d = M(a, Ee, 1);
            Jb(c, 1, d);
        }
        !M(c, rf, 2).length && M(a, rf, 2).length && ((d = M(a, rf, 2)), Jb(c, 2, d));
        void 0 === Eb(c, sf, 5, !1) && void 0 !== Eb(a, sf, 5, !1) && ((a = L(a, sf, 5)), Hb(c, 5, a));
        Qf({ na: c, u: Tg(b), ea: 2 });
    }
    function Vg(a, b, c, d, e) {
        ...
        if (a || f || b) {
            ...
            f && (h.pppd = f);
            b && (h.pppnc = b);
            U(Ff).g(Wd.g, Wd.defaultValue) && (h.ppc_eid = U(Ff).g(Wd.g, Wd.defaultValue).toString());
            a = h;
        } else a = void 0;
        if (a) {
            c = [c ? new Q(ec, "https://pagead2.googlesyndication.com") : new Q(ec, "https://securepubads.g.doubleclick.net"), new Q(ec, "/pagead/ppub_config")];
            f = "";
            for (b = 0; b < c.length; b++) f += gc(c[b]);
            c = mc.exec(lc(new R(f, nc)).toString());
            f = c[3] || "";
            c = new R(c[1] + oc("?", c[2] || "", a) + oc("#", f), nc);
            Wg(c, d, e);
        } else e(new p.globalThis.Error("no provided or inferred data"));
    }
    function Wg(a, b, c) {
        ...
        d.withCredentials = !1;
        d.onload = function () {
            300 > d.status ? (ag("13", window), b(204 === d.status ? "" : d.responseText)) : c(new p.globalThis.Error("resp:" + d.status));
        };
        d.onerror = function () {
    ...
    var Xg = function () {
        ...
        $g = function (a, b, c, d, e) {
            if (Oc(b) === Pc(b) && c) {
                Yg(a);
                var f = null == e ? void 0 : Mb(Fb(e, bc), 1);
                Gf(Xd) && f && f.length && q(b.location.hostname, "includes").call(b.location.hostname, f)
                    ? Zg(a, void 0, e)
                    : Vg(
                          b.top,
                          c,
        ...
        Yg = function (a) {
            Pg(260);
            Qg(260, function (b) {
                void 0 !== a.g || a.h ? b(a.g, a.h) : a.j.push(b);
            });
        },
        Zg = function (a, b, c, d) {
            a.g = null != b ? b : null == c ? void 0 : Yb(c);
            a.m = c;
            !a.m && a.g && a.i.length && (a.m = dc(a.g));
            a.h = d;
            b = u(a.j);
            for (c = b.next(); !c.done; c = b.next()) (c = c.value), c(a.g, a.h);
            b = u(a.i);
            for (c = b.next(); !c.done; c = b.next()) (c = c.value), c(a.m, a.h);
            a.j.length = 0;
            a.i.length = 0;
        };
    function ah() {
    ...
    var dh = function () {
            return [].concat(w(q(ch, "values").call(ch))).reduce(function (a, b) {
                return a + b;
            }, 0);
        },
        ch = new p.Map();
    function eh(a, b, c) {
        if (a.va) {
            ...
            try {
                var v = [].concat(w(q(ch, "keys").call(ch)));
                Ab(k, 3, v, ub);
            } catch (t) {}
            Ib(g, 4, Ld, k);
            J(g, 5, a.la, 0);
    ...
    var fh = ja(["https://pagead2.googlesyndication.com/pagead/managed/js/gpt/", "/pubads_impl.js"]),
        gh = ja(["https://pagead2.googlesyndication.com/gpt/pubads_impl_", ".js"]),
        hh = ja(["https://securepubads.g.doubleclick.net/pagead/managed/js/gpt/", "/pubads_impl.js"]),
        ih = ja(["https://securepubads.g.doubleclick.net/gpt/pubads_impl_", ".js"]);
    function jh() {
        var a = kh,
            b = Fb(lh, tf),
            c = mh,
            d = { pa: Kb(lh, 5), qa: N(rb(G(lh, 2)), 0), wa: zb(lh, 10, rb), ma: N(rb(G(lh, 7)), 0), oa: Mb(lh, 6) },
            e = L(lh, cc, 9),
            f,
            h = null != (f = a.fifWin) ? f : window,
            g = h.document;
        f = a.fifWin ? window : h;
        bh("_loaded_", !0);
        var k = nh(c);
        bh("cmd", []);
        var l;
        c = null != (l = oh(g)) ? l : ph(g);
        qh(b, h, q(Object, "assign").call(Object, {}, { fa: c }, d), k);
        try {
            rg();
        } catch (pa) {}
        ag("1", h);
        ...
        if (!sh(g)) {
            ...
            try {
                Lc(g, Ac(b, { id: h, nonce: Ec() }));
            } catch (pa) {}
            g.getElementById(h) && (Gf(Ud) ? (d = !0) : (a._loadStarted_ = !0));
        }
        if (Gf(Ud) ? !d : !a._loadStarted_) {
            var n = ad("SCRIPT");
            Kc(n, b);
            n.async = !0;
            ...
            var v,
                t,
                B = null != (t = null != (v = g.head) ? v : b) ? t : d;
            "complete" !== f.document.readyState && a.fifWin
                ? ic(f, "load", function () {
                      return void B.appendChild(n);
                  })
                : B.appendChild(n);
            Gf(Ud) || (a._loadStarted_ = !0);
        }
        f === f.top && oe(f);
        $g(new Xg(), f, c, th(c), e);
    }
    function uh() {
        ...
        1 > a || Math.floor(a) !== a ? (Yf({ v: "2019072601" }), (a = "1")) : (a = "2019072601");
        return { ga: a, N: "m202306010101", sa: $c(window), ta: new Rd(), va: 0.01 > Sc(), la: 100 };
    }
    function nh(a) {
        var b = new Q(ec, "2019072601");
        var c = a.N;
        /m\d+/.test(c) ? (c = Number(c.substring(1))) : (c && Yf({ mjsv: c }), (c = void 0));
        return q(Object, "assign").call(Object, {}, a, { Ma: b, Oa: c, Pa: new Q(ec, "m202306010101") });
    }
    function oh(a) {
    ...
    function ph(a) {
        ...
        for (b = a.next(); !b.done; b = a.next()) if (((b = b.value), q(b.src, "includes").call(b.src, "/tag/js/gpt"))) return b;
        return null;
    }
    function rh(a, b) {
        var c = a.ga;
        a = a.N;
        b = th(b) ? (a ? bd(fh, a) : bd(gh, c)) : a ? bd(hh, a) : bd(ih, c);
        return (c = U(Ff).g(Yd.g, Yd.defaultValue)) ? cd(b, new p.Map([["cb", c]])) : b;
    }
    function qh(a, b, c, d) {
        Qg(172, c.fa);
        Ug(a, c);
        ...
        Gf(Vd) ||
            ((a = Lg(b)) &&
                a.then(function (e) {
                    return void Qg(251, Yb(e));
                }));
        gf(U(Ff).i(Zd.g, Zd.defaultValue), b.document);
    }
    function sh(a) {
        var b = oh(a);
    ...
    var wh = ac(vh);
    vh.o = [10];
    var xh = "undefined" === typeof sttc ? void 0 : sttc;
    try {
        var kh = ah(),
            mh = uh(),
            yh;
        ...
        try {
            ...
            if (!qe(xh)) {
                var Bh = Ah ? Ah() + "\n" : "";
                throw Error(Bh + String(xh));
            }
            yh = wh(xh);
        } catch (a) {
            eh(zh, 838, a), (yh = new vh());
        }
        var lh = yh,
            Ch = kh,
            Dh = lh,
            Eh = !U(Og).g,
            Fh = $b();
        if (!Eh) throw Error((Fh && Fh()) || String(Eh));
        q(Object, "assign").call(Object, Ng, Ch._vars_);
        Ch._vars_ = Ng;
        Dh && (Kb(Dh, 3) && Qg(36, !0), Kb(Dh, 5) && Qg(221, !0), Mb(Dh, 6) && Qg(150, Mb(Dh, 6)));
        jh();
    } catch (a) {
        try {
            eh(uh(), 420, a);
